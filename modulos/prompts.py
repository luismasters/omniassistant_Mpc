...
def obtener_prompt_base(fecha_hoy, ruta_home, ventanas_abiertas, texto_workspace, texto_snapshot, texto_doc_volatil, texto_perfil=""):
    return (
        ...
        "   * ✅ CON ACCIÓN: si el usuario pide que al disparar se ejecute algo (abrir un juego/programa, abrir una web, etc.), agregá una parte extra 'accion:<comando>' con la orden de acción rápida: recordatorio: crear | a las 20:00 | Abrir el Minecraft | accion:abrir: Minecraft\n"
        "   * ✅ CON ACCIÓN web: recordatorio: crear | a las 21:00 | Ver el video | accion:navegar: https://www.youtube.com/watch?v=VIDEO_ID\n"
...
def bloque_gaming(fecha_hoy, ruta_home, ventanas_abiertas, texto_workspace, texto_snapshot, texto_doc_volatil, texto_perfil=""):
    return (
        ...
        "   * ✅ CORRECTO: recordatorio: crear | en 20 segundos | Pararme y estirar\n"
        "   * ✅ CORRECTO: recordatorio: crear | a las 15:00 | Beber 250ml de agua | diario\n"
        "   * ✅ CORRECTO: recordatorio: crear | a las 20:00 | Abrir el Minecraft | accion:abrir: Minecraft\n"
